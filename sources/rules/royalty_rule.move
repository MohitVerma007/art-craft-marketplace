...
module ArtCraft::royalty_rule {
    ...
    public fun add(
        policy: &mut TransferPolicy<Product>,
        cap: &TransferPolicyCap<Product>,
        amount_bp: u16,
        min_amount: u64
    ) {
    ...
    public fun pay(
        policy: &mut TransferPolicy<Product>,
        request: &mut TransferRequest<Product>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<Product>, paid: u64): u64 {
